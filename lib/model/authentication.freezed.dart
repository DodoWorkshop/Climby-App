...
abstract class $AuthenticationCopyWith<$Res> {
  ...
  @useResult
  $Res call({UserProfile profile, String jwt});
}
...
class _$AuthenticationImpl implements _Authentication {
  const _$AuthenticationImpl({required this.profile, required this.jwt});
  ...
  @override
  String toString() {
    return 'Authentication(profile: $profile, jwt: $jwt)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, profile, jwt);
...
abstract class _Authentication implements Authentication {
  const factory _Authentication(
      ...
      required final String jwt}) = _$AuthenticationImpl;
